 ...
 **/
p7r::error_t
foo(p7r::time_point const &, p7r::events_t, p7r::connector *)
{
  // no-op
...
p7r::error_t
bar(p7r::time_point const &, p7r::events_t, p7r::connector *)
{
  // no-op
  return p7r::ERR_UNEXPECTED;
}
...
p7r::error_t
baz(p7r::time_point const &, p7r::events_t, p7r::connector *)
{
  // no-op
  return p7r::ERR_UNEXPECTED;
}
